...
Public Class MicexISSClient
    ...
    Public Sub New(Optional ByVal cookies As CookieContainer = Nothing)
        cookiejar = cookies
        urls.Add("history_secs", "http://www.micex.ru/iss/history/engines/{0}/markets/{1}/boards/{2}/securities.xml?date={3}&start={4}")
        urls.Add("engines", "http://www.micex.ru/iss/engines.xml")
        urls.Add("markets", "http://www.micex.ru/iss/engines/{0}/markets.xml")
        urls.Add("boards", "http://www.micex.ru/iss/engines/{0}/markets/{1}/boards.xml")
    End Sub
