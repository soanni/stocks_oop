...
Public Class MicexAuth
    ...
    Public url_auth = "https://passport.micex.ru/authenticate"
    ' URL that will be used as URI to find a cookie for the correct domain
    Public url_uri = "http://www.micex.ru"
    ...
    Public Sub Auth()
        Try
            Dim AuthReq As HttpWebRequest = DirectCast(WebRequest.Create(url_auth), HttpWebRequest)
            ...
            AuthResponse = DirectCast(AuthReq.GetResponse(), HttpWebResponse)
            AuthResponse.Close()
